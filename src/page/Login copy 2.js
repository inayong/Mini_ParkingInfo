    ...
    return (
        <main className='grow'>
            <div className="h-screen bg-gray-100">
                <div className='border-4 flex justify-center sm:py-12'>
                    <div className='w-1/5'></div>
                    <div className='relative w-3/5'>
                        <div className='border-4 py-12'>로그인
                            <div className='absolute inset-0 bg-gradient-to-r from-blue-300 to-blue-600 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl w-1/2'></div>
                            <div className='relative bg-white shadow-lg sm:rounded-3xl sm:p-20 w-1/2'>
